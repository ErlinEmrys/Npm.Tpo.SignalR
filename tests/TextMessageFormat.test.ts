...
{
	( [ [ "\u001e", [ "" ] ], [ "\u001e\u001e", [ "", "" ] ], [ "Hello\u001e", [ "Hello" ] ], [ "Hello,\u001eWorld!\u001e", [ "Hello,", "World!" ] ] ] as [ string, string[] ][] ).forEach( ( [ payload, expectedMessages ] ) =>
	{
	...
	( [ [ "", "Message is incomplete." ], [ "ABC", "Message is incomplete." ], [ "ABC\u001eXYZ", "Message is incomplete." ] ] as [ string, string ][] ).forEach( ( [ payload, expectedError ] ) =>
	{
