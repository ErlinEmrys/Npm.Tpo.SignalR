...
{
	const transportTypes = [ HttpTransportType.WebSockets, HttpTransportType.ServerSentEvents, HttpTransportType.LongPolling ];
	transportTypes.forEach( ( t ) => action( t ) );
}

export function eachEndpointUrl( action: ( givenUrl: string, expectedUrl: string ) => void ): void
{
	const urls = [ [ "http://tempuri.org/endpoint/?q=my/Data", "http://tempuri.org/endpoint/negotiate?q=my%2FData&negotiateVersion=1" ], [ "http://tempuri.org/endpoint?q=my/Data", "http://tempuri.org/endpoint/negotiate?q=my%2FData&negotiateVersion=1" ], [ "http://tempuri.org/endpoint", "http://tempuri.org/endpoint/negotiate?negotiateVersion=1" ], [ "http://tempuri.org/endpoint/", "http://tempuri.org/endpoint/negotiate?negotiateVersion=1" ] ];
